...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        ...
        this.markerTitle = 'Text for marker';
        ...
        this._iconInfo = {
            markerType: angular_maps__WEBPACK_IMPORTED_MODULE_1__["MarkerTypeId"].None,
    ...
    AppComponent.prototype._click = function () {
        console.log("hello world...");
    };
    AppComponent.prototype.addMarkert = function () {
        this._box = {
    ...
    AppComponent.prototype.addSecondMarkert = function () {
        this._box = {
            maxLatitude: 32,
            maxLongitude: -92,
            minLatitude: 29,
    ...
    AppComponent.prototype.optionSelected = function (event) {
        this._box = {
...
/* harmony import */ var angular_maps__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! angular-maps */ "./node_modules/angular-maps/fesm5/angular-maps.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
function MapServiceProviderFactory() {
    var bc = new angular_maps__WEBPACK_IMPORTED_MODULE_6__["BingMapAPILoaderConfig"]();
    bc.apiKey = "Ap0AObt84NcDaUThCeWOj52ZqUHv6k4TJhjLibR-DghC-semgoj-0uPbIi8r0E4j"; // your bing map key
    bc.branch = "experimental";
    // to use the experimental bing brach. There are some bug fixes for
    // clustering in that branch you will need if you want to use 
    // clustering.
    return new angular_maps__WEBPACK_IMPORTED_MODULE_6__["BingMapAPILoader"](bc, new angular_maps__WEBPACK_IMPORTED_MODULE_6__["WindowRef"](), new angular_maps__WEBPACK_IMPORTED_MODULE_6__["DocumentRef"]());
}
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
                ...
                angular_maps__WEBPACK_IMPORTED_MODULE_6__["MapModule"].forRoot()
            ],
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _components_toolbar_toolbar_component__WEBPACK_IMPORTED_MODULE_3__["ToolbarComponent"]],
            providers: [{
                    provide: angular_maps__WEBPACK_IMPORTED_MODULE_6__["MapAPILoader"], deps: [], useFactory: MapServiceProviderFactory
                }],
...
module.exports = "<mat-toolbar color=\"primary\">\r\n    <form class=\"example-form\">\r\n        <mat-form-field class=\"example-full-width\">\r\n            <input type=\"text\" #firstname=\"matInput\" id=\"inputValue\" \r\n                placeholder=\"Pick one\"\r\n                aria-label=\"Number\"\r\n                matInput [formControl]=\"myControl\"\r\n                [matAutocomplete]=\"auto\">\r\n            <mat-autocomplete #auto=\"matAutocomplete\">\r\n                <mat-option (click)=\"selectedOption(option,i)\" *ngFor=\"let option of options; let i = index\" [value]=\"option.name\">\r\n                    {{option.name}}\r\n                </mat-option>\r\n            </mat-autocomplete>\r\n        </mat-form-field>\r\n    </form>\r\n\r\n</mat-toolbar>"
...
var ToolbarComponent = /** @class */ (function () {
    function ToolbarComponent() {
        this.acselectedOption = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    ...
    ToolbarComponent.prototype.selectedOption = function (event, index) {
    ...
    ], ToolbarComponent.prototype, "acselectedOption", void 0);
...
module.exports = __webpack_require__(/*! D:\mls\angular-work-space\angular-material\src\main.ts */"./src/main.ts");
